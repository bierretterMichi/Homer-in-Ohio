...
Es wird also z.B. getestet, ob W gedrückt wird und wenn dies der Fall ist, läuft Homer vorwärts. Die Geschwindigkeit kann man ändern, indem man die Schrittanzahl vergrößert oder verlkeinert. |
| 
